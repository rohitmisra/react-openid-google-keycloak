...
import { GOOGLE, KEY_CLOAK } from "./config";
...
export class KeyCloakOAuth extends OAuth {
  constructor(options: Partial<ConfigOptions> & { redirect_uri: string }) {
    super({
      client_id: KEY_CLOAK.CLIENT_ID,
      client_secret: KEY_CLOAK.CLIENT_SECRET,
      auth_url: KEY_CLOAK.AUTH_URL,
      token_url: KEY_CLOAK.TOKEN_URL,
      ...options
    });
  }
}
